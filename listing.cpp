...
void Listing::displayDetails() const {
    ...
    std::cout << "Item Status: " << item_status << "\n";
...
std::string Listing::getCategory() const {
    return category;
}
...
std::string Listing::getCondition() const {
    return condition;
}

std::string Listing::getStatus() const {
    return item_status;
}

std::string Listing::getLocation() const {
    return location;
}
