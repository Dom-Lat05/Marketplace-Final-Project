...
void MarketplaceSystem::filterListingsByPrice(double minPrice, double maxPrice) const {
    marketplace.filterListingsByPrice(minPrice, maxPrice);
}

void MarketplaceSystem::sortListingsByPriceLowToHigh() const {
    marketplace.sortListingsByPriceLowToHigh();
}

void MarketplaceSystem::sortListingsByPriceHighToLow() const {
    marketplace.sortListingsByPriceHighToLow();
}
...
void MarketplaceSystem::loadData() {
    ...
    if (listingFile.is_open()) {
        ...
        while (std::getline(listingFile, line)) {
            std::stringstream ss(line);

            std::string name, description, category, condition, status, location;
            std::string priceStr;
            ...
            Listing listing(name, description, category, condition, status, location, price);
